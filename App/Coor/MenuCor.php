          ...
          <li class="has-sub">
                ...
                <div class="sub-menu">
                  <li class="has-sub">
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#data-tables" aria-expanded="false" aria-controls="data-tables">
                      <span class="nav-text">Valoración</span> <b class="caret"></b>
                    </a>
                    <ul class="collapse" id="data-tables">
                      <div class="sub-menu">

                        <li>
                          <a href="basic-data-table.html">Terapia ocupacional</a>
                        </li>
                  ...
                  <li class="has-sub">
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#informe2" aria-expanded="false" aria-controls="informe2">
                      <span class="nav-text">Administrativos</span> <b class="caret"></b>
                    </a>
                  ...
                  <li class="has-sub">
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#informe3" aria-expanded="false" aria-controls="informe3">
                      <span class="nav-text">Seguimiento</span> <b class="caret"></b>
                    </a>
                    <ul class="collapse" id="informe3">
                      <div class="sub-menu">

                        <li>
                          <a href="InfoPED.php">PED</a>
                        </li>

                        <li>
                          <a href="responsive-data-table.html">Malla semanal</a>
                        </li>

                        <li>
                          <a href="MallaMensual.php">Malla mensual</a>
                        </li>

                        <li>
                          <a href="expendable-data-table.html">Indicadores seguimiento</a>
                        </li>

                        <li>
                          <a href="expendable-data-table.html">Acta de satisfacción</a>
                        </li>
            ...
            <li class="has-sub">
              <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#documentation" aria-expanded="false" aria-controls="documentation">
                ...
                <span class="nav-text">EPS</span> <b class="caret"></b>
              </a>
              <ul class="collapse" id="documentation" data-parent="#sidebar-menu">
                <div class="sub-menu">

                  <li>
                    <a class="sidenav-item-link" href="Eps.php">
                      <span class="nav-text">Listar EPS</span>
